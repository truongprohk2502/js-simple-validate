...
type MobilePhoneLocale = keyof typeof phones;

/**
 * Validates if the given string is mobile phone number or not.
 *
 * @param {any} input The string to validate.
 * @param {MobilePhoneLocale} locale The locale of mobile phone.
 * @returns {boolean} Returns true if the string is mobile phone, false otherwise.
 */
const isMobilePhone = (
  input: any,
  ...
  const phoneRegex = phones[locale as MobilePhoneLocale];
